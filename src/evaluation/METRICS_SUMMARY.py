...
TEXT_METRICS = {
    ...
    "BERTScore": {
        ...
        "components": [
            ...
            "bertscore_f1_base",
            "bertscore_precision_idf",
            "bertscore_recall_idf",
            "bertscore_f1_idf",
            "bertscore_precision_rescaled",
            "bertscore_recall_rescaled",
            "bertscore_f1_rescaled",
            "bertscore_precision_full",
            "bertscore_recall_full",
            "bertscore_f1_full",
        ],
        "range": "[0, 1]",
