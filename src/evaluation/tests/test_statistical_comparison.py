...
class TestWilcoxonSignedRankTest:
    ...
    def test_two_tailed_p_value(self):
        ...
        diff = np.array([0.1, 0.1, 0.1, 0.1,  # 4 positive
                         -0.05, -0.05, -0.05, -0.05, -0.05, -0.05])  # 6 negative
...
class TestGoodmanKruskalGamma:
    ...
    def test_weak_association(self):
        ...
        assert "Moderate" in result['interpretation'] or "Strong" in result['interpretation']
...
class TestKappaCoefficient:
    ...
    def test_perfect_agreement(self):
        ...
        Z_i = [set(['url1', 'url2', 'url3']),
                set(['url1', 'url2']),
                set(['url3'])]
        Z_j = [set(['url1', 'url2', 'url3']),
               set(['url1', 'url2']),
               set(['url3'])]
...
class TestPairedPermutationTest:
    ...
    def test_clear_difference(self):
        ...
        result = paired_permutation_test(scores_A, scores_B, n_permutations=1000, seed=42)
    ...
    def test_two_sided_vs_one_sided(self):
        ...
        result_two = paired_permutation_test(scores_A, scores_B, n_permutations=1000, 
                                              seed=42, alternative="two-sided")
        result_greater = paired_permutation_test(scores_A, scores_B, n_permutations=1000,
                                                  seed=42, alternative="greater")
    ...
    def test_reproducibility_seed(self):
        ...
        result1 = paired_permutation_test(scores_A, scores_B, n_permutations=500, seed=123)
        result2 = paired_permutation_test(scores_A, scores_B, n_permutations=500, seed=123)
