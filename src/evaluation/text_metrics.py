...
def _rouge_scores(
    ...
    *,
    ...
    def _rouge_n_single(hyp_tok: list[str], ref_tok: list[str], n: int) -> dict[str, float]:
    ...
    def _rouge_n_best(hyp_tok: list[str], refs_tok: list[list[str]], n: int) -> dict[str, float]:
    ...
    def _rouge_n_jackknife(hyp_tok: list[str], refs_tok: list[list[str]], n: int) -> dict[str, float]:
    ...
    refs_list: list[list[list[str]]] = []   # refs_list[i] = list of tokenised refs for hyp i
    ...
    for hyp_tok, refs_tok in zip(hyps_tok, refs_list):
